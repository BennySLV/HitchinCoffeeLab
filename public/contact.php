			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<form id="contact-form" action="contact.php" method="post" autocomplete="off">
						<fieldset><legend id="form-instructions">Please fill in all fields<button id="close-button">X Close</button></legend>						
							<p><input id="first-name" type="text" name="first-name" placeholder="First Name" /> <span id="first-name-flag"><i aria-hidden="true"></i></span> <span id="first-name-validation"></span></p>
							...
							<p><textarea id="message" placeholder="Message..." rows="5" cols="25"></textarea> <span id="message-flag"><i aria-hidden="true"></i></span> <span id="message-validation"></span></p>
							<input id="reset-button" type="button" name="resetButton" value="Reset" />
