/** 
* Contact Form JavaScript/jQuery
*
* This code is designed to be re-used for all Front-End 
...
$(function() {
	...
	$('#reset-button').on('click', function(event) {
		...
		var confirmReset = confirm("Are you sure you want to reset and clear the form?");
